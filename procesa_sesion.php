...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Losa+de+Roboto|Pantalla+Playfair">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Car Wash AUto Fenesse </a>
  <button class="navbar-toggler position-absolute d-md-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <input class="form-control form-control-light w-100" type="text" placeholder="Buscar" aria-label="Buscar">
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Historial de los servicios</h2>
